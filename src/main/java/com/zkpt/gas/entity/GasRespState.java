...
public enum GasRespState {
    SUCESS("0000", "查询成功"), FAIL_DETAIL("0002", "查询失败（具体见返回内容）"), NOARREARS("0110", "没有欠费信息"), FAIL("0111", "查询失败"), MOREARREARS("0112", "欠费月份太多，需要到营业所进行查询缴费"), FAIL_PAYMENT(
            "0120", "缴费失败（具体信息见返回内容）"), FORMAL_ERROR("0121",
                    "数据格式错误"), ONLY_TODAY("0130", "冲帐失败只能冲当天帐"), NO_LEDGER_FILE("0190", "未收到对账日志文件"), LEDGER_FILE_FORMAL_ERROR("0191", "对账日志文件格式错误");
    private String key;
    private String desc;
