 ...
 *
 */
public class GasProtocalPackage implements IGenProtocalPackage, java.io.Serializable {
    private static final long serialVersionUID = -7817998005606755190L;
    ...
    private long echoTimeMillis; // 响应时间(毫秒)
     ...
     * @param gasCommand
     * @param echoTime
     * @param echoTimeMillis
     */
    public GasProtocalPackage(GasPacketHeadEntity packetHead, String packetBody, GasCommand gasCommand, Date echoTime, long echoTimeMillis) {
        super();
        this.packetHead = packetHead;
        this.packetBody = packetBody;
        this.gasCommand = gasCommand;
        this.echoTime = echoTime;
        this.echoTimeMillis = echoTimeMillis;
    }
    ...
    public long getEchoTimeMillis() {
        return echoTimeMillis;
    }

    public void setEchoTimeMillis(long echoTimeMillis) {
        this.echoTimeMillis = echoTimeMillis;
    }
