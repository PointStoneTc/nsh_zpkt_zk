...
public class GasPacketHeadEntity {
    ...
    public void setRequestId_s(String requestId_s) {
        ...
        this.requestId = ProtocolTxTUtil.strToCharArray(requestId_s);
    }
    ...
    public void setBankNo_s(String bankNo_s) {
        ...
        this.bankNo = ProtocolTxTUtil.strToCharArray(bankNo_s);
    }
    ...
    public void setBankDeviceNo_s(String bankDeviceNo_s) {
        ...
        this.bankDeviceNo = ProtocolTxTUtil.strToCharArray(bankDeviceNo_s);
    }
    ...
    public void setBankBizSn_s(String bankBizSn_s) {
        ...
        this.bankBizSn = ProtocolTxTUtil.strToCharArray(bankBizSn_s);
    }
    ...
    public void setTimeStamp_s(String timeStamp_s) {
        ...
        this.timeStamp = ProtocolTxTUtil.strToCharArray(timeStamp_s);
    }
    ...
    public void setRespondState_s(String respondState_s) {
        ...
        this.respondState = ProtocolTxTUtil.strToCharArray(respondState_s);
    }
    ...
    public void setIsNextPacket_s(String isNextPacket_s) {
        ...
        this.isNextPacket = ProtocolTxTUtil.strToCharArray(isNextPacket_s);
    }
}
