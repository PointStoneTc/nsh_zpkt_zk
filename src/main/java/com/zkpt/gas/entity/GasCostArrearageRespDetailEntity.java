...
public class GasCostArrearageRespDetailEntity implements java.io.Serializable {
    ...
    public void setMonth_s(String month_s) {
        ...
        this.month = ProtocolTxTUtil.strToCharArray(month_s);
    }
    ...
    public void setPrevVal_s(String prevVal_s) {
        ...
        this.prevVal = ProtocolTxTUtil.strToCharArray(prevVal_s);
    }
    ...
    public void setCurrVal_s(String currVal_s) {
        ...
        this.currVal = ProtocolTxTUtil.strToCharArray(currVal_s);
    }
    ...
    public void setAirVal_s(String airVal_s) {
        ...
        this.airVal = ProtocolTxTUtil.strToCharArray(airVal_s);
    }
    ...
    public void setAirCost_s(String airCost_s) {
        ...
        this.airCost = ProtocolTxTUtil.strToCharArray(airCost_s);
    }
    ...
    public void setPayAbleAirNum_s(String payAbleAirNum_s) {
        ...
        this.payAbleAirNum = ProtocolTxTUtil.strToCharArray(payAbleAirNum_s);
    }
    ...
    public void setLateFee_s(String lateFee_s) {
        ...
        this.lateFee = ProtocolTxTUtil.strToCharArray(lateFee_s);
    }
    ...
    public void setPayAbleAirCost_s(String payAbleAirCost_s) {
        ...
        this.payAbleAirCost = ProtocolTxTUtil.strToCharArray(payAbleAirCost_s);
    }
    ...
    public void setAirVal1_s(String airVal1_s) {
        ...
        this.airVal1 = ProtocolTxTUtil.strToCharArray(airVal1_s);
    }
    ...
    public void setAirCost1_s(String airCost1_s) {
        ...
        this.airCost1 = ProtocolTxTUtil.strToCharArray(airCost1_s);
    }
    ...
    public void setAirVal2_s(String airVal2_s) {
        ...
        this.airVal2 = ProtocolTxTUtil.strToCharArray(airVal2_s);
    }
    ...
    public void setAirCost2_s(String airCost2_s) {
        ...
        this.airCost2 = ProtocolTxTUtil.strToCharArray(airCost2_s);
    }
    ...
    public void setAirVal3_s(String airVal3_s) {
        ...
        this.airVal3 = ProtocolTxTUtil.strToCharArray(airVal3_s);
    }
    ...
    public void setAirCost3_s(String airCost3_s) {
        ...
        this.airCost3 = ProtocolTxTUtil.strToCharArray(airCost3_s);
    }
    ...
    public void setAirVal4_s(String airVal4_s) {
        ...
        this.airVal4 = ProtocolTxTUtil.strToCharArray(airVal4_s);
    }
    ...
    public void setAirCost4_s(String airCost4_s) {
        ...
        this.airCost4 = ProtocolTxTUtil.strToCharArray(airCost4_s);
    }
}
