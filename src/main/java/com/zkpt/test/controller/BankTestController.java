...
public class BankTestController {
    ...
    @ResponseBody
    public String generalLedger(String bankNo, String ledgerDate, HttpServletRequest request, HttpServletResponse response) {
        try {
            bankTestService.generalLedger(bankNo, ledgerDate);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
