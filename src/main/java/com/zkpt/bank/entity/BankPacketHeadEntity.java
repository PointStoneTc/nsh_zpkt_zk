...
public class BankPacketHeadEntity {
    public final static String B_SN_QZ = "rq";
    ...
    public void setFixedNumber_s(String fixedNumber_s) {
        ...
        this.fixedNumber = ProtocolTxTUtil.strToCharArray(fixedNumber_s);
    }
    ...
    public void setPaymentCode_s(String paymentCode_s) {
        ...
        this.paymentCode = ProtocolTxTUtil.strToCharArray(paymentCode_s);
    }
    ...
    public void setPaymentPointPassword_s(String paymentPointPassword_s) {
        ...
        this.paymentPointPassword = ProtocolTxTUtil.strToCharArray(paymentPointPassword_s);
    }
    ...
    public void setSpare_s(String spare_s) {
        ...
        this.spare = ProtocolTxTUtil.strToCharArray(spare_s);
    }
    ...
    public void setTransactionMode_s(String transactionMode_s) {
        ...
        this.transactionMode = ProtocolTxTUtil.strToCharArray(transactionMode_s);
    }

    public String getTransactionFlow_s() {
        return B_SN_QZ + transactionFlow_s;
    }

    public void setTransactionFlow_s(String transactionFlow_s) {
        this.transactionFlow_s = transactionFlow_s;
        this.transactionFlow = ProtocolTxTUtil.strToCharArray(transactionFlow_s);
    }
    ...
    public void setDataLength_s(String dataLength_s) {
        ...
        this.dataLength = ProtocolTxTUtil.strToCharArray(dataLength_s);
    }
    ...
    public void setBaotouEnd_s(String baotouEnd_s) {
        ...
        this.baotouEnd = ProtocolTxTUtil.strToCharArray(baotouEnd_s);
    }
}
